...
/datum/outfit/job/roguetown/adventurer/runaway_prisoner/pre_equip(mob/living/carbon/human/H, visualsOnly)
	...
	add_bounty(H.real_name, race, gender, descriptor_height, descriptor_body, descriptor_voice, rand(100, 200), FALSE, my_crime, "The Justiciary of Azuria", H.client.prefs.compliance)
