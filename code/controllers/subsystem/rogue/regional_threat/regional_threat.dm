		...
		threat_regions = list(
			...
			new /datum/threat_region(
				...
				_faction_weights = list(
					...
					QUEST_FACTION_TARICHEA_DEADITE = 10,
					...
					QUEST_FACTION_DUSTED_DEADITE = 15,
					QUEST_FACTION_DUNE_RAIDERS = 15,
				),
