...
//New Defines
#define MUNDANE_POP_SCALE_PENALTY 8
#define MODERATE_POP_SCALE_PENALTY 12
#define MAJOR_POP_SCALE_PENALTY 20
#define ROLESET_POP_SCALE_PENALTY 20
#define OBJECTIVES_POP_SCALE_PENALTY 28
#define RAID_POP_SCALE_PENALTY 30
