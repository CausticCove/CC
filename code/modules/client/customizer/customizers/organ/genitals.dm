...
/datum/customizer_choice/organ/penis/generate_pref_choices(list/dat, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type) //Caustic Revert - Do not let upstream files modify these datums or it will break the character customizers
	..()
	var/datum/customizer_entry/organ/penis/penis_entry = entry
...
/datum/customizer_choice/organ/penis/handle_topic(mob/user, list/href_list, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type) //Caustic Revert - Do not let upstream files modify these datums or it will break the character customizers
	..()
	var/datum/customizer_entry/organ/penis/penis_entry = entry
...
/datum/customizer_choice/organ/testicles/generate_pref_choices(list/dat, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type) //Caustic Revert - Do not let upstream files modify these datums or it will break the character customizers
	..()
	var/datum/customizer_entry/organ/testicles/testicles_entry = entry
	if(can_customize_size)
...
/datum/customizer_choice/organ/testicles/handle_topic(mob/user, list/href_list, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type) //Caustic Revert - Do not let upstream files modify these datums or it will break the character customizers
	..()
	var/datum/customizer_entry/organ/testicles/testicles_entry = entry
	switch(href_list["customizer_task"])
		if("ball_size")
...
/datum/customizer_choice/organ/breasts/generate_pref_choices(list/dat, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type) //Caustic Revert - Do not let upstream files modify these datums or it will break the character customizers
	..()
	var/datum/customizer_entry/organ/breasts/breasts_entry = entry
...
/datum/customizer_choice/organ/breasts/handle_topic(mob/user, list/href_list, datum/preferences/prefs, datum/customizer_entry/entry, customizer_type) //Caustic Revert - Do not let upstream files modify these datums or it will break the character customizers
	..()
	var/datum/customizer_entry/organ/breasts/breasts_entry = entry
	switch(href_list["customizer_task"])
		if("breast_size")
