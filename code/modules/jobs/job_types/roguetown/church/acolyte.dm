/datum/job/roguetown/monk
	...
	job_traits = list(TRAIT_RITUALIST, TRAIT_GRAVEROBBER, TRAIT_HOMESTEAD_EXPERT, TRAIT_CLERGY, TRAIT_MARRIAGE_CAPABLE, TRAIT_CIVILIZEDBARBARIAN) //cc edit, makes unarmed usable/viable
