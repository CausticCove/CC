...
/datum/job/roguetown/martyr
	...
	virtue_restrictions = list(/datum/virtue/utility/noble, /datum/virtue/combat/rotcured, /datum/virtue/utility/deadened, /datum/virtue/combat/dualwielder, /datum/virtue/heretic/zchurch_keyholder)// CC Edit: Removed /datum/virtue/utility/deathless because deathless is entirely removed.
