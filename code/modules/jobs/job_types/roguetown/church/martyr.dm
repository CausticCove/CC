...
/datum/job/roguetown/martyr
	...
	virtue_restrictions = list(/datum/virtue/utility/noble, /datum/virtue/combat/rotcured, /datum/virtue/utility/deadened, /datum/virtue/combat/dualwielder, /datum/virtue/heretic/zchurch_keyholder) //CAUSTIC EDIT: We remvoed deathless
