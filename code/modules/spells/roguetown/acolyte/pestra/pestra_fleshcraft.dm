...
/proc/perform_fleshcraft_transform_choice(mob/living/carbon/human/H, mob/living/carbon/human/chooser, chosen)
	...
	switch(chosen)
		...
		if("penis size")
			should_update = fleshcraft_change_size(H, chooser, ORGAN_SLOT_PENIS, "Choose penis size", "Penis Size", "penis_size", list("small" = 1, "average" = 2, "large" = 3, "extra-large" = 4, "massive" = 5, "enormous" = 6, "baothan" = 7))
		...
		if("testicle size")
			should_update = fleshcraft_change_size(H, chooser, ORGAN_SLOT_TESTICLES, "Choose testicle size", "Testicle Size", "ball_size", list("small" = 1, "average" = 2, "large" = 3, "extra-large" = 4, "massive" = 5, "enormous" = 6, "huge" = 7, "baothan" = 8))
		...
		if("breast size")
			should_update = fleshcraft_change_size(H, chooser, ORGAN_SLOT_BREASTS, "Choose breast size", "Breast Size", "breast_size", list("Flat" = 0, "very small" = 1, "Small" = 2, "normal" = 3, "Large" = 4, "enormous" = 5, "towering" = 6, "huge" = 7, "gargantuan" = 8, "colossal" = 9, "ungodly big" = 10, "gigantic" = 11, "titanic" = 12, "obscenely large" = 13, "over-endowed" = 14, "unholy" = 15, "baothan" = 16, "extra baothan" = 17, "over-baothan" = 18, "downright incredible" = 19))
