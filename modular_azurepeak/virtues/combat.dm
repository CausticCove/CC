...
/datum/virtue/combat/shielder
	...
	custom_text = "Guaranteed Apprentice for Swords & Journeyman for Shields." // Caustic Edit
...
/datum/virtue/combat/shielder/apply_to_human(mob/living/carbon/human/recipient)
	recipient.adjust_skillrank_up_to(/datum/skill/combat/swords, SKILL_LEVEL_APPRENTICE, silent = TRUE) // Caustic Edit
