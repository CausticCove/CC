...
/datum/vore_look/import_panel/proc/import_belly(mob/host, list/input_data)
	...
	for(var/list/belly_data in valid_lists)
		...
		*/
		...
		var/possible_fullscreens = cached_icon_states('icons/mob/vore_fullscreens/screen_full_vore_list.dmi')
		if(!new_belly.colorization_enabled)
			possible_fullscreens = cached_icon_states('icons/mob/vore_fullscreens/screen_full_vore.dmi')
